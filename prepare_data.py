...
IN_FILE = os.path.join("./data/tmgi_at_init_36.csv")
OUT_FILE = os.path.join("./data/tmgi_at_init_36_gen.csv")
...
def add_noise_make_data(ref_trajectory, n_ecoli=1000):
	...
	noise_matrix = np.random.normal(2, 1, size=(n_ecoli, ref_trajectory.shape[0]))
